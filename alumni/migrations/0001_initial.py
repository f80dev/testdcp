# Generated by Django 3.0.11 on 2021-04-01 09:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('links', django.contrib.postgres.fields.jsonb.JSONField(help_text="Liens vers des références externes à l'oeuvre", null=True)),
                ...
                ('files', django.contrib.postgres.fields.jsonb.JSONField(help_text='Liens vers des documents attaché', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female'), ('N', 'Non précisé')], default='M', max_length=1)),
                ...
                ('links', django.contrib.postgres.fields.jsonb.JSONField(help_text='Liens vers des références externes au profil', null=True)),
                ('auto_updates', models.CharField(default='0,0,0,0,0,0', help_text='Date de mise a jour', max_length=300)),
                ('advices', django.contrib.postgres.fields.jsonb.JSONField(help_text="Liste de conseils alimenter par l'outil pour augmenter le rayonnement d'une personne", null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(help_text="Auteur de l'article", on_delete=django.db.models.deletion.CASCADE, related_name='Articles', to='alumni.Profil')),
            ],
        ),
    ]
